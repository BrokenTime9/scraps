  ...
  return (
    <header className="absolute top-0 flex w-full justify-between bg-slate-950 text-slate-50 dark:bg-slate-950 ">
      ...
      >
        ...
        <h1 className="m-0 pr-1 font-spectral text-slate-50 decoration-orange-500 decoration-[3px] underline-offset-[3px] hover:underline">
          D.P. Bh
          <span className="inline-block h-4 w-4 rounded-full bg-orange-500 dark:bg-orange-500 sm:h-[1.15rem] sm:w-[1.15rem]"></span>
          sale
        </h1>
      </Link>
      <Link
